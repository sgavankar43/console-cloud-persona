...
const BulbHolder = () => {
  ...
  const toggleTheme = () => {
    ...
    if (isDark) {
      ...
      // Switch to dark mode - hold the bulb
      setIsHeld(true);
      setTimeout(() => {
        setIsDark(true);
  ...
  return (
    <div className="fixed top-4 right-4 z-50">
      <div className="relative">
        {/* Bulb Holder */}
        <div className="relative w-16 h-12 bg-gray-300 dark:bg-gray-700 rounded-t-lg border-2 border-gray-400 dark:border-gray-600 shadow-lg">
          {/* Holder grip */}
